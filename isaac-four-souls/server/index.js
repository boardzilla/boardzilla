...
class FourSouls extends GameInterface {
  constructor(seed) {
    ...
    this.hidden = () => `card[flipped], #player-mat:not(.mine) #hand card, #loot card, #treasure card, #monsters card, #characters card, #eternals card`;

    this.play = async () => {
      this.playersMayAlwaysMove('.mine card, .mine counter, #board counter, .mine die, #shop card, #dungeon card, #bonusSouls card');
    ...
    this.actions = {
      ...
      getCharDeck: {
        ...
        if: () => this.pile.find('card[type="character"]'),
        action: () => this.board.find('#characters').add('card[type="character"]'),
      },
      removeCharDeck: {
        prompt: "Remove characters",
        if: () => this.board.find('card[type="character"]'),
        action: () => this.board.find('#characters').clear('card[type="character"]'),
      },
      intoEternalDeckTop: {
        prompt: "Put on top of deck",
      ...
      getEternalDeck: {
        prompt: "Get eternals",
        if: () => this.pile.find('card[type="eternal"]'),
        action: () => this.board.find('#eternals').add('card[type="eternal"]'),
      },
      removeEternalDeck: {
        prompt: "Remove eternals",
        if: () => this.board.find('card[type="eternal"]'),
        action: () => this.board.find('#eternals').clear('card[type="eternal"]'),
      },
    };
